...
def index(request):
    data = {}
    #ProductTable.objects.all() #This will fetch non-active products also. So it is better to use filter
...
#    #in above line we have created custom order id by combining user id & current time stamp
...
def make_payment(request):
   ...
   client = razorpay.Client(auth=("rzp_test_XTITFs1gKurVOZ", "cgg4A1fHAmaoQse4oNvfllZn"))
